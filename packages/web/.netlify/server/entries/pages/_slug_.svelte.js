...
async function load({ fetch, params }) {
  const pageData = await (0, import_helpers_6eb64bb9.f)({ fetch, dataJson: `/${params.slug}.json` });
  return { props: { pageData } };
}
const U5Bslugu5D = (0, import_index_790fe6b2.c)(($$result, $$props, $$bindings, slots) => {
  let { pageData } = $$props;
  if ($$props.pageData === void 0 && $$bindings.pageData && pageData !== void 0)
    $$bindings.pageData(pageData);
  return `${(0, import_index_790fe6b2.v)(import_PageBuilder_0127b942.P, "PageBuilder").$$render($$result, { blocks: pageData.content }, {}, {})}`;
});
